...
//creates options for autonomous
 ...
 // private static final String kSForwardAuto = "move forward short";
  ...
  private static final String kLDockAuto = "Dock and low cube";
  private static final String kMDockAuto = "Dock and middle game piece";
  private static final String kNewMDockAuto = "New Dock and middle game piece";
  ...
  private static final String kTopAndGoAuto = "Drop game piece at top and leave community";
  private static final String kMiddleAndGoAuto = "Drop game piece in middle and leave community";
...
*/
  ...
  public void robotInit() {
    ...
    m_chooser.addOption("Drop game piece at top and leave community",kTopAndGoAuto);
    m_chooser.addOption("Drop game piece in middle and leave community",kMiddleAndGoAuto);
    m_chooser.addOption("Dock and low cube", kLDockAuto);
    m_chooser.addOption("Dock and middle game piece", kMDockAuto);
    m_chooser.addOption("New Dock and middle game piece", kNewMDockAuto);
...
*/
  ...
  } else if(timeElapsed > 7 && timeElapsed < 7.7) {
    m_leftleadMotor.set(0.2);
    m_rightleadMotor.set(0.2);
  }
  else {
...
if (m_autoSelected == kMiddleAndGoAuto) {
  ...
  } else if (timeElapsed > 5 && timeElapsed < 14 && SensorActive == false) {
    m_leftleadMotor.set(-0.1);
    m_rightleadMotor.set(0.1);
    leftGateMotor.set(0);
    rightGateMotor.set(0);
...
if (m_autoSelected == kLDockAuto) {
     
  if (timeElapsed < 2) {
  LowerIntake.set(-0.5);
  } else if (timeElapsed > 2 && timeElapsed < 6.27) {
    m_leftleadMotor.set(-0.15);
    m_rightleadMotor.set(0.15);
    LowerIntake.set(0);
  } else if(timeElapsed > 6.27 && timeElapsed < 7) {
    m_leftleadMotor.set(0.2);
    m_rightleadMotor.set(0.2);
    LowerIntake.set(0);
  }
...
if (m_autoSelected == kMDockAuto) {
     
  if (timeElapsed < 2.5) {
  armMotor.set(0.5);
  } else if (timeElapsed > 2.5 && timeElapsed < 4.5) {
    leftGateMotor.set(-0.5);
    rightGateMotor.set(-0.5);
  } else if (timeElapsed > 4.5 && timeElapsed < 8.85 && SensorActive == false) {
    m_leftleadMotor.set(-0.15);
    m_rightleadMotor.set(0.15);
    leftGateMotor.set(0);
    rightGateMotor.set(0);
    armMotor.set(-0.5);
  } else if (timeElapsed > 8.85 && timeElapsed < 9.55) {
    m_leftleadMotor.set(0.2);
    m_rightleadMotor.set(0.2);
    leftGateMotor.set(0);
    rightGateMotor.set(0);
...
if (m_autoSelected == kNewMDockAuto) {
  ...
  armMotor.set(0.5);
    ...
    rightGateMotor.set(0);
    armMotor.set(0);
  } else if (timeElapsed > 9.55 && timeElapsed < 14) {
    armMotor.set(-0.5);
  }
    else {
    m_leftleadMotor.set(0);
